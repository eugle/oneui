...
var getColor = exports.getColor = function getColor(c, o, over) {
    ...
    if (c instanceof Array && c.length >= 1) {
        ...
        if (Object.keys(_color.DefaultColor).includes(cc)) {
            var _current = Object.keys(_color3.default).includes(cc) ? _color3.default[cc] : cc;
            c = co || co === 0 ? 'rgba(' + _color.DefaultColor[_current + 'RGB'] + ',' + opacity + ')' : _color.DefaultColor[_current];
        }
        //如果是rgba色
